...
var Editor, editor;
	...
	async function edit(){
		...
		toast_css.href = "/assets/toastui-editor.css";
		...
		toast_js.src = "/assets/toastui-editor-all.min.js";
		...
		toast_js.onload = async function(){
			...
			// fetch the md
			let request = await fetch("http://localhost/magical-web-presence/Markdownitor_dil.php?type=fetch&post="+window.location.pathname);
	...
	function save(){
		...
		fetch("http://localhost/magical-web-presence/Markdownitor_dil.php?type=save&post="+window.location.pathname, options)
		  .then(response => {
			if (response.ok) {
	...
	function del(){
		...
		fetch("http://localhost/magical-web-presence/Markdownitor_dil.php?type=delete&post="+window.location.pathname)
		  .then(response => {
			if (response.ok) {
			  return response.json();
			} else {
